...
public class CircularProgressBar extends View {
    ...
    public CircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        try {
            final int bgColor = args.getColor(R.styleable.circularProgressBar_bgColor, getResources().getColor(R.color.alpha_black));
            final int bgStrokeWidth = args.getDimensionPixelSize(R.styleable.circularProgressBar_bgStrokeWidth,
                    (int) defaultStrokeWidth);

            final int progressColor = args.getColor(R.styleable.circularProgressBar_progressColor, getResources().getColor(R.color.alpha_green));
            ...
            this.mShowText = args.getBoolean(R.styleable.circularProgressBar_showTextBar, false);
            final int textSize = args.getDimensionPixelSize(R.styleable.circularProgressBar_android_textSize,
                    (int) defaultTextSize);
            final int textColor = args.getInt(R.styleable.circularProgressBar_android_textColor, getResources().getColor(R.color.alpha_green));
